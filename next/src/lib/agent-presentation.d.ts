...
export interface ChatEntry { id: string; role: 'assistant' | 'user'; content: string; result?: AgentResult; kind?: 'context'; contextId?: string }
export function chatHistory(history: AgentTurn[], currentContextId?: string): ChatEntry[]
export function contextEntry(contextId: string): ChatEntry
