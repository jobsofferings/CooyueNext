          ...
          <div className="row">
            <div className="col-xl-3 col-lg-6 col-md-6">
              <div className="footer-widget__column footer-widget__about">
                ...
                <p className="footer-widget__about-text">{siteConfig.company.legalName} · Cooyue Tech</p>
              </div>
            </div>
            <div className="col-xl-3 col-lg-6 col-md-6">
              <div className="footer-widget__column footer-widget__link">
                ...
                <ul className="footer-widget__link-list list-unstyled">
                  ...
                  <li><Link href={getLocalizedHref('/products')}>{dict('Products')}</Link></li>
            ...
            <div className="col-xl-3 col-lg-6 col-md-6">
              <div className="footer-widget__column footer-widget__newsletter">
                <div className="footer-widget__title-box">
                  <h3 className="footer-widget__title">{dict('Send Email')}</h3>
                </div>
                <p className="footer-widget__about-text">{dict('Write message')}</p>
