...
export const productModules: Record<Locale, ProductModule[]> = {
  zh: [
    ...
    },
    {
      ...
      detail: '3D 机身屏幕中的画面为程序生成的成像预览，不是实测数据。',
      tags: ['LCD 触控', '多角度查看'],
    },
    {
    ...
    },
    {
      ...
      detail: '电池位置、内部连接及拆卸路径仅作功能预览，实际操作请遵循原厂手册。',
      tags: ['锂电池供电', '现场巡检'],
    },
  ],
  en: [
...
export const experienceCopy = {
  zh: {
    embeddedTitle: '3D 交互预览', embeddedIntro: '自动展示整机与拆解过程，也可拖动模型、点击部件自由查看。',
    playDemo: '播放预览', pauseDemo: '暂停预览', gestureHint: '拖动旋转 · 滚轮或双指缩放',
    ...
    previewDescription: '切换三种预览配色，观察同一模拟场景中的不同视觉表达。机身屏幕与预览窗口实时联动。',
    thermal: '铁红热像', gas: '气体增强', mono: '白热灰阶', simulated: '程序模拟 · 非实测画面',
    previewNote: '预览配色不代表设备的完整模式清单；不用于气体识别、浓度判断或安全决策。',
    ...
    paletteLabel: '选择预览配色', viewLabel: '选择模型视图', moduleLabel: '选择产品功能模块',
    fullscreen: '全屏查看', exitFullscreen: '退出全屏',
  },
  en: {
    embeddedTitle: '3D interactive preview', embeddedIntro: 'View the assembly animation, or drag the model and select a module to explore.',
    playDemo: 'Play preview', pauseDemo: 'Pause preview', gestureHint: 'Drag to rotate · Scroll or pinch to zoom',
    ...
    previewNote: 'Preview palettes are not a complete device mode list. Not for gas identification, concentration measurement or safety decisions.',
    ...
    paletteLabel: 'Choose a preview palette', viewLabel: 'Choose a model view', moduleLabel: 'Choose a product module',
