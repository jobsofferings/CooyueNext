...
const copy = {
  zh: {
    ...
    notice: '当前为关键词 / 同义词检索与资料摘述模式，未接入大模型或向量数据库。候选匹配不代表满足全部工况，不能替代现场安全评估。',
    ...
    empty: '没有找到足够的已审核资料。请补充目标气体或型号；资料未覆盖不等于产品不支持。',
  ...
  en: {
    ...
    notice: 'Validation mode: keyword / synonym retrieval and reviewed excerpts, without an LLM or vector database. Matches do not establish suitability for all conditions or replace a site safety assessment.',
    ...
    empty: 'No sufficient reviewed evidence was found. Add a target gas or model; missing evidence does not mean a product is incompatible.',
