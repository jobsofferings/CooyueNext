              ...
              <div className="col-xl-7 col-lg-6">
                <div className="services-one__left">
                  <div className="section-title text-left">
                    ...
                    <h2 className="section-title__title">Offering the Best Consulting <br /> &amp; Finance <span>Services</span></h2>
                  </div>
                </div>
              </div>
              <div className="col-xl-5 col-lg-6">
                <div className="services-one__right">
                  <p className="services-one__text">Lorem ipsum dolor sit amet, consectetur notted adipisicing <br /> elit sed do eiusmod tempor incididunt ut labore et simply free text dolore magna aliqua lonm andhn.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="services-one__bottom">
            <div className="row">
              <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                <div className="services-one__single">
                  <div className="services-one__title-box">
                    <h3 className="services-one__title"><Link href={`/${lang}/services/capital-market`}>Capital Market</Link></h3>
                  </div>
                  ...
                  <div className="services-one__read-more">
                    <Link href={`/${lang}/services/capital-market`}>Read More<span className="icon-right-arrow"></span></Link>
                  </div>
                </div>
              </div>
              <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div className="services-one__single">
                  <div className="services-one__title-box">
                    <h3 className="services-one__title"><Link href={`/${lang}/services/insurance`}>Insurance</Link></h3>
                  </div>
                  <div className="services-one__img-box">
                    <div className="services-one__img">
                  ...
                  <div className="services-one__read-more">
                    <Link href={`/${lang}/services/insurance`}>Read More<span className="icon-right-arrow"></span></Link>
                  </div>
                </div>
              </div>
              <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                <div className="services-one__single">
                  <div className="services-one__title-box">
                    <h3 className="services-one__title"><Link href={`/${lang}/services/mutual-funds`}>Mutual Funds</Link></h3>
                  </div>
                  <div className="services-one__img-box">
                    <div className="services-one__img">
                  ...
                  <div className="services-one__read-more">
                    <Link href={`/${lang}/services/mutual-funds`}>Read More<span className="icon-right-arrow"></span></Link>
                  </div>
                </div>
              </div>
              <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div className="services-one__single">
                  <div className="services-one__title-box">
                    <h3 className="services-one__title"><Link href={`/${lang}/services/portfolio-management`}>Portfolio Management</Link></h3>
                  </div>
                  <div className="services-one__img-box">
                    <div className="services-one__img">
                  ...
                  <div className="services-one__read-more">
                    <Link href={`/${lang}/services/portfolio-management`}>Read More<span className="icon-right-arrow"></span></Link>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="project-one">
        <div className="container">
          <div className="section-title text-center">
            ...
            <h2 className="section-title__title">Recently Completed Our <br /> Clients <span>Projects</span></h2>
          </div>
          <div className="project-one__bottom">
            <div className="project-one__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{"loop": true, "autoplay": false, "margin": 30, "nav": true, "dots": false, "smartSpeed": 500, "autoplayTimeout": 10000, "navText": ["<span class=\"icon-left-arrow\"></span>","<span class=\"icon-right-arrow\"></span>"], "responsive": {"0": {"items": 1}, "768": {"items": 2}, "992": {"items": 3}, "1200": {"items": 3}}}'>
              <div className="item">
                <div className="project-one__single">
                  ...
                  <div className="project-one__content">
                    <p>Finance</p>
                    <h3><Link href={`/${lang}/portfolio/1`}>International business <br /> development</Link></h3>
                    <div className="project-one__arrow">
                      <Link href={`/${lang}/portfolio/1`}><span className="icon-right-arrow"></span></Link>
                    </div>
                  </div>
                </div>
              </div>
